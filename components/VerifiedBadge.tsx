...
export default function VerifiedBadge({ className, size = "sm", variant = "default" }: VerifiedBadgeProps) {
  ...
  return (
    <svg
      className={cn(sizeMap[size], "shrink-0", colorClass, className)}
      viewBox="0 0 24 24"
      fill="none"
...
/** Helper: returns VerifiedBadge variant based on premium_plan */
export function getBadgeVariant(premiumPlan?: string | null): "default" | "max" {
