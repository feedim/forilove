# Forilove Sablon Olusturma Rehberi
...
Sablondaki belirli bolumleri kullanicinin istege bagli olarak gizleyebilmesini saglar. Editorde bolum uzerinde hover yapildiginda sag ustte ✕ butonu goruntulenir.
...
- `data-area` elemani `position: relative` almali veya zaten oyle olmali (✕ butonu `position: absolute` ile konumlanir)
...
- `data-area` elemanlarina hover'da sag ustte ✕ butonu goruntulenir
