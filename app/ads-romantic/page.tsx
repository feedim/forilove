  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden" role="main" lang="tr">
      ...
      <section className="relative min-h-[100svh] flex flex-col items-center justify-center px-5 py-12 sm:py-16 -mt-[73px] pt-[73px] text-center" style={{ zIndex: 1 }}>
        <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-pink-500/15 rounded-full blur-[150px] pointer-events-none" />
        <div className="absolute bottom-1/4 right-0 w-[200px] h-[200px] bg-purple-500/10 rounded-full blur-[100px] pointer-events-none" />
