...
export default function PreviewPage() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      let sanitized = DOMPurify.sanitize(cleanHtml, { WHOLE_DOCUMENT: true, ADD_TAGS: ['iframe', 'video', 'audio', 'source', 'style', 'link'], ADD_ATTR: ['allow', 'allowfullscreen', 'frameborder', 'scrolling', 'target', 'media', 'rel', 'crossorigin', 'href', 'as'], ALLOW_DATA_ATTR: true });
      // Remove editorial data attributes (keep functional ones like data-flag, data-question)
